...
const RULE_SECTIONS = [
  ...
  "시민은 행동 + 피사체 형태의 제시어를 받습니다.",
  "마피아는 시민 제시어와 헷갈릴 수 있도록 유사하지만 다른 행동 + 피사체 제시어를 받습니다.",
  "각 플레이어는 자기 턴에 그림을 그립니다.",
  "모든 플레이어가 그림을 그린 뒤, 그림을 보고 마피아를 추리해 투표합니다.",
  "시민이 마피아를 잡고, 마피아가 시민 제시어를 맞추지 못하면 시민 승리입니다.",
  "시민이 마피아를 잡았지만 마피아가 시민 제시어를 맞추면 마피아 승리입니다.",
